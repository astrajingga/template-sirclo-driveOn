...
const classesOrderSummary = {
  ...
  subTotalClassName: "order-summary__bodyOrder",
  subTotalTextClassName: "order-summary__bodyOrder--label-subtotal",
  subTotalPriceClassName: "order-summary__bodyOrder--subtotal",
...
const classesCartDetails = {
  className: "cartOrderSummaryBoxCustom_body",
  cartHeaderClassName: "d-none",
  itemClassName: "cartItemOrder",
  itemImageClassName: "cartItemOrder_image",
  itemTitleClassName: "cartItemOrder_detail",
  itemPriceClassName: "cartItemOrder_priceCalculate",
  itemRegularPriceClassName: "cartItemOrder_priceRegular",
  itemSalePriceClassName: "cartItemOrder_priceSale",
  itemSalePriceWrapperClassName: "cartItemOrder_priceSaleWrapper",
  itemDiscountNoteClassName: "cartItemOrder_discNote",
  itemRegularAmountClassName: "d-none",
  headerQtyClassName: "d-none",
  titleClassName: "cartItemOrder_title",
  itemQtyClassName: "cartItemOrder_qty",
  qtyBoxClassName: "cartItemOrder_qtyBox",
  itemAmountClassName: "cartItemOrder_price",
  ...
  cartBodyClassName: "cartOrderSummaryBoxCustom_body"
}

const OrderSummaryBoxCustom: FC<any> = ({
  i18n,
  auth,
  page,
  withOrderDetail
  ...
  return (
    <>
      <div className="heading__titleOrder">
        <h6>{i18n.t("cart.summary")}</h6>
      </div>
      <div className="order-summary__wrapperCustom">
        {withOrderDetail &&
          <div className="cartOrderSummaryBoxCustom order-1">
            <div className="flex cart_orderSummaryBoxTitle">
              <p className="cartOrderSummaryBoxCustom_title">{i18n.t("orderSummary.orderSummary")}</p>
            </div>
            <CartDetails
...
export default OrderSummaryBoxCustom
